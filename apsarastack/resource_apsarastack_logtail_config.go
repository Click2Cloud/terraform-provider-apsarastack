...
func resourceApsaraStackLogtailConfigCreate(d *schema.ResourceData, meta interface{}) error {
	...
	if err != nil {
		return WrapErrorf(err, DefaultErrorMsg, "apsarastack_logtail_config", "CreateConfig", ApsaraStackSdkGoERROR)
	}
	if debugOn() {
...
func resourceApsaraStackLogtailConfiglUpdate(d *schema.ResourceData, meta interface{}) error {
	...
	if update {
		...
		if err != nil {
			return WrapErrorf(err, DefaultErrorMsg, d.Id(), "UpdateConfig", ApsaraStackSdkGoERROR)
		}
		if debugOn() {
...
func resourceApsaraStackLogtailConfigDelete(d *schema.ResourceData, meta interface{}) error {
	...
	if err != nil {
		...
		return WrapErrorf(err, DefaultErrorMsg, d.Id(), "DeleteConfig", ApsaraStackSdkGoERROR)
	}
