...
func resourceApsaraStackLogtailAttachmentCreate(d *schema.ResourceData, meta interface{}) error {
	...
	if err != nil {
		return WrapErrorf(err, DefaultErrorMsg, "apsarastack_logtail_attachment", "ApplyConfigToMachineGroup", ApsaraStackSdkGoERROR)
	}
	if debugOn() {
...
func resourceApsaraStackLogtailAttachmentDelete(d *schema.ResourceData, meta interface{}) error {
	...
	if err != nil {
		return WrapErrorf(err, DefaultErrorMsg, d.Id(), "RemoveConfigFromMachineGroup", ApsaraStackSdkGoERROR)
	}
	if debugOn() {
