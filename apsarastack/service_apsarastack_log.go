...
func (s *LogService) DescribeLogProject(id string) (*sls.LogProject, error) {
	...
	if err != nil {
		if IsExpectedErrors(err, []string{"ProjectNotExist"}) {
			return project, WrapErrorf(err, NotFoundMsg, ApsaraStackSdkGoERROR)
		}
		return project, WrapErrorf(err, DefaultErrorMsg, id, "GetProject", ApsaraStackSdkGoERROR)
	}
...
func (s *LogService) DescribeLogStore(id string) (*sls.LogStore, error) {
	...
	if err != nil {
		if IsExpectedErrors(err, []string{"ProjectNotExist", "LogStoreNotExist"}) {
			return store, WrapErrorf(err, NotFoundMsg, ApsaraStackSdkGoERROR)
		}
		return store, WrapErrorf(err, DefaultErrorMsg, id, "GetLogStore", ApsaraStackSdkGoERROR)
	}
...
func (s *LogService) DescribeLogStoreIndex(id string) (*sls.Index, error) {
	...
	if err != nil {
		if IsExpectedErrors(err, []string{"ProjectNotExist", "LogStoreNotExist", "IndexConfigNotExist"}) {
			return index, WrapErrorf(err, NotFoundMsg, ApsaraStackSdkGoERROR)
		}
		return index, WrapErrorf(err, DefaultErrorMsg, id, "GetIndex", ApsaraStackSdkGoERROR)
	}
...
func (s *LogService) DescribeLogMachineGroup(id string) (*sls.MachineGroup, error) {
	...
	if err != nil {
		if IsExpectedErrors(err, []string{"ProjectNotExist", "GroupNotExist", "MachineGroupNotExist"}) {
			return group, WrapErrorf(err, NotFoundMsg, ApsaraStackSdkGoERROR)
		}
		return group, WrapErrorf(err, DefaultErrorMsg, id, "GetMachineGroup", ApsaraStackSdkGoERROR)
	}
...
func (s *LogService) DescribeLogtailConfig(id string) (*sls.LogConfig, error) {
	...
	if err != nil {
		...
		return response, WrapErrorf(err, DefaultErrorMsg, id, "GetConfig", ApsaraStackSdkGoERROR)
	}
...
func (s *LogService) DescribeLogtailAttachment(id string) (groupName string, err error) {
	...
	if err != nil {
		if IsExpectedErrors(err, []string{"ProjectNotExist", "ConfigNotExist", "MachineGroupNotExist"}) {
			return groupName, WrapErrorf(err, NotFoundMsg, ApsaraStackSdkGoERROR)
		}
		return groupName, WrapErrorf(err, DefaultErrorMsg, id, "GetAppliedMachineGroups", ApsaraStackSdkGoERROR)
	}
...
func (s *LogService) DescribeLogAlert(id string) (*sls.Alert, error) {
	...
	if err != nil {
		if IsExpectedErrors(err, []string{"ProjectNotExist", "JobNotExist"}) {
			return alert, WrapErrorf(err, NotFoundMsg, ApsaraStackSdkGoERROR)
		}
		return alert, WrapErrorf(err, DefaultErrorMsg, id, "GetLogstoreAlert", ApsaraStackSdkGoERROR)
	}
...
func (s *LogService) DescribeLogDashboard(id string) (*sls.Dashboard, error) {
	...
	if err != nil {
		if IsExpectedErrors(err, []string{"ProjectNotExist", "DashboardNotExist"}) {
			return dashboard, WrapErrorf(err, NotFoundMsg, ApsaraStackSdkGoERROR)
		}
		return dashboard, WrapErrorf(err, DefaultErrorMsg, id, "GetLogstoreDashboard", ApsaraStackSdkGoERROR)
	}
