...
func resourceApsaraStackLogStoreCreate(d *schema.ResourceData, meta interface{}) error {
	...
	if err != nil {
		return WrapErrorf(err, DefaultErrorMsg, "apsarastack_log_store", "CreateLogStoreV2", ApsaraStackSdkGoERROR)
	}
...
func resourceApsaraStackLogStoreRead(d *schema.ResourceData, meta interface{}) error {
	...
	if err != nil {
		return WrapErrorf(err, DefaultErrorMsg, "apsarastack_log_store", "ListShards", ApsaraStackSdkGoERROR)
	}
...
func resourceApsaraStackLogStoreUpdate(d *schema.ResourceData, meta interface{}) error {
	...
	if update {
		...
		if err != nil {
			return WrapErrorf(err, DefaultErrorMsg, d.Id(), "UpdateLogStoreV2", ApsaraStackSdkGoERROR)
		}
		if debugOn() {
...
func resourceApsaraStackLogStoreDelete(d *schema.ResourceData, meta interface{}) error {
	...
	if err != nil {
		...
		return WrapErrorf(err, DefaultErrorMsg, d.Id(), "DeleteLogStore", ApsaraStackSdkGoERROR)
	}
