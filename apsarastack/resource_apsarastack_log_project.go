...
func resourceApsaraStackLogProjectCreate(d *schema.ResourceData, meta interface{}) error {
	...
	if err := resource.Retry(2*time.Minute, func() *resource.RetryError {
		...
		return WrapErrorf(err, DefaultErrorMsg, "alicloud_log_project", "CreateProject", ApsaraStackSdkGoERROR)
	}
...
func resourceApsaraStackLogProjectUpdate(d *schema.ResourceData, meta interface{}) error {
	...
	if d.HasChange("description") {
		...
		if err != nil {
			return WrapErrorf(err, DefaultErrorMsg, d.Id(), "UpdateProject", ApsaraStackSdkGoERROR)
		}
...
func resourceApsaraStackLogProjectDelete(d *schema.ResourceData, meta interface{}) error {
	...
	if err != nil {
		...
		return WrapErrorf(err, DefaultErrorMsg, d.Id(), "DeleteProject", ApsaraStackSdkGoERROR)
	}
